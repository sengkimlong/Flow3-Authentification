...
class PostController extends PostController_Original implements \TYPO3\Flow\Object\Proxy\ProxyInterface {
	...
	public function __construct() {
		if ('SKL\Post\Controller\PostController' === get_class($this)) {
	...
	$reflectedClass = new \ReflectionClass('SKL\Post\Controller\PostController');
	$allReflectedProperties = $reflectedClass->getProperties();
	foreach ($allReflectedProperties as $reflectionProperty) {
		$propertyName = $reflectionProperty->name;
		if (in_array($propertyName, array('Flow_Aop_Proxy_targetMethodsAndGroupedAdvices', 'Flow_Aop_Proxy_groupedAdviceChains', 'Flow_Aop_Proxy_methodIsInAdviceMode'))) continue;
		if (isset($this->Flow_Injected_Properties) && is_array($this->Flow_Injected_Properties) && in_array($propertyName, $this->Flow_Injected_Properties)) continue;
		if ($reflectionProperty->isStatic() || $reflectionService->isPropertyAnnotatedWith('SKL\Post\Controller\PostController', $propertyName, 'TYPO3\Flow\Annotations\Transient')) continue;
		...
		if (is_object($this->$propertyName) && !$this->$propertyName instanceof \Doctrine\Common\Collections\Collection) {
			if ($this->$propertyName instanceof \Doctrine\ORM\Proxy\Proxy) {
				...
				$varTagValues = $reflectionService->getPropertyTagValues('SKL\Post\Controller\PostController', $propertyName, 'var');
	 ...
	 */
	 private function Flow_Proxy_injectProperties() {
		...
		$postRepository_reference = &$this->postRepository;
		$this->postRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('SKL\Post\Domain\Repository\PostRepository');
		if ($this->postRepository === NULL) {
			$this->postRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('fe7715c3dcc4e9c4c1fd18de2fcb6df4', $postRepository_reference);
			if ($this->postRepository === NULL) {
				$this->postRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('fe7715c3dcc4e9c4c1fd18de2fcb6df4',  $postRepository_reference, 'SKL\Post\Domain\Repository\PostRepository', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('SKL\Post\Domain\Repository\PostRepository'); });
			}
		}
		...
		$authorRepository_reference = &$this->authorRepository;
		$this->authorRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getInstance('SKL\Post\Domain\Repository\AuthorRepository');
		if ($this->authorRepository === NULL) {
			$this->authorRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->getLazyDependencyByHash('561001c60d1f889db81150b11a5923f9', $authorRepository_reference);
			if ($this->authorRepository === NULL) {
				$this->authorRepository = \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->createLazyDependency('561001c60d1f889db81150b11a5923f9',  $authorRepository_reference, 'SKL\Post\Domain\Repository\AuthorRepository', function() { return \TYPO3\Flow\Core\Bootstrap::$staticObjectManager->get('SKL\Post\Domain\Repository\AuthorRepository'); });
			}
		}
...
# PathAndFilename: /var/www/html/flow-login/Packages/Application/SKL.Post/Classes/SKL/Post/Controller/PostController.php
#